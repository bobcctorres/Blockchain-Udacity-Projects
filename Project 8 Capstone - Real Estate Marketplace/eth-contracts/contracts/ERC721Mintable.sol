...
contract Ownable {
    ...
    function owner() public view returns (address isOwner) {
        return _owner;        
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        //require (!isContract(newOwner), "New Owner must not be a contract");
        _owner = newOwner;
...
//  TODO's: Create a Pausable contract that inherits from the Ownable contract
    ...
    event Paused (address trigger_addr);
    event Unpaused (address trigger_addr);
}
...
contract ERC721 is Pausable, ERC165 {
    ...
    function ownerOf(uint256 tokenId) public view returns (address) {
        ...
        address owner_addr = _tokenOwner[tokenId];
        require(owner_addr != address(0), "Invalid owner address");
        return owner_addr;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require (to != ownerOf (tokenId), "To address must not be the owner of the tokenId");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(!_exists(tokenId), "TokenId does already exist");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require (from == ownerOf(tokenId), "'From' address must be the owner of TokenId");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function setTokenURI(uint256 tokenId) internal {
        ...
        string memory concatURI = strConcat (_baseTokenURI, uint2str(tokenId));
        _tokenURIs[tokenId] = concatURI;
    }

}

//  TODO's: Create CustomERC721Token contract that inherits from the ERC721Metadata contract. You can name this contract as you please
contract RealEstateERC721Token is ERC721Metadata {
//  1) Pass in appropriate values for the inherited ERC721Metadata contract
//      - make the base token uri: https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/
    constructor () public ERC721Metadata ("RealEstateCapstone", "RSC", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
