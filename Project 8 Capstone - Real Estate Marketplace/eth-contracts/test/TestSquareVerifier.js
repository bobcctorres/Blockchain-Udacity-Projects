...
// - use the contents from proof.json generated from zokrates steps
        ...
        it('verification with correct proof',async function(){            
            let verify = await this.contract.verifyTx.call (base_proof.proof.A, base_proof.proof.A_p, base_proof.proof.B, base_proof.proof.B_p,
                base_proof.proof.C, base_proof.proof.C_p, base_proof.proof.H, base_proof.proof.K, base_proof.input, {from:account_one});
        ...
        it('verification with incorrect proof',async function(){        
            let verify = await this.contract.verifyTx.call (base_proof.proof.A, base_proof.proof.A_p, base_proof.proof.B, base_proof.proof.B_p,
                base_proof.proof.C, base_proof.proof.C_p, base_proof.proof.H, base_proof.proof.K, [12, 4], {from:account_one});
